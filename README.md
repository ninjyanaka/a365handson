...
> [!IMPORTANT]
> - 本資料は**理解を助けるための非公式のハンズオン資料**であり、Microsoft の公式ドキュメントではありません。
> - **Microsoft Agent 365 はプレビュー中の機能を多く含み、UI・コマンド・仕様・提供条件は今後変更される可能性があります。** 本資料の内容は執筆時点のものであり、実際の画面・挙動と異なる場合があります。
> - 実施前には、各ページの「参考」「参考リンク」に掲載した Microsoft Learn 等の一次情報で最新の仕様をご確認ください。
