...
[← 目次](./README.md) ｜ [← Step 6：公開](./06-publish.md) ｜ [次：Step 8 ガバナンス →](./08-governance.md)
...
**Block（一時停止）されたエージェントの検出**（[Step 8：ガバナンス](./08-governance.md) の Kill Switch と突き合わせる）
...
[← Step 6：公開](./06-publish.md) ｜ [次：Step 8 ガバナンス →](./08-governance.md)
