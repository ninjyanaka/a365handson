# Step 6 — 管理・ガバナンス（ポリシー / CA / ライフサイクル）

[← 目次](./README.md) ｜ [← Step 5](./step5-publish.md) ｜ [次：Step 7 観測 →](./step7-observability.md)
...
[← Step 5](./step5-publish.md) ｜ [次：Step 7 観測 →](./step7-observability.md)
