...
> [!NOTE]
> この応答はエージェント側からは一般的な通信エラーと区別しにくいのが既知の課題として挙げられています。実際にポリシーブロックが原因かは、GSA 側の[ネットワークトラフィックログ](https://learn.microsoft.com/entra/global-secure-access/how-to-view-traffic-logs)で確認してください。
